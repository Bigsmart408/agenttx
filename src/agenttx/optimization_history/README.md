...
commands still execute through the same try wrapper and close-time cleanup. Full
causal recovery remains correct; the no-trace ablation still retains the derived
report as expected.
