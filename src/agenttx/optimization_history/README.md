...
removed; rollback still performs GC before returning. Full causal recovery remains
correct; the no-trace ablation still retains the derived report as expected.
