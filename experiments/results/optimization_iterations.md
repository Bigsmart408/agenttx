...
| 6 | `iteration_06_persistent_try_worker` | incremental upperdir snapshot with hard-linked unchanged entries | 151.531 | 162.104 | 2 | 18.839 | True | snapshot stage 0.384 -> 0.158 s over 63 incremental calls; endpoint pair noisy; no end-to-end speedup claim |
