...
Iteration 04 is a directional two-repeat measurement. The before pair was collected immediately before the change and the after pair immediately after it, but the VM was not interleaved; use the values for engineering guidance, not as the final statistical claim.
