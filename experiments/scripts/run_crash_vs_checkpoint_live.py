#!/usr/bin/env python3
"""Live causal vs checkpoint: finish the official task after mid-crash recovery.

Unlike the oracle crash sample, the agent must implement the official unit of
work. Checkpoints are the two time-axis restores: temporal (before the fault
step) and whole-branch abort (session start). Causal keeps independent notes
and only drops the fault cone.
"""
...
def main() -> int:
    ...
    argv = [
        ...
        "--result-subdir", "crash_vs_checkpoint_live",
